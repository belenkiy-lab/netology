...
for index, course in enumerate(courses_list):
	duration_index.append([..., ...])
	mcount_index.append() # Напишите код по аналогии с duration_index
...
# Допишите код ниже:
print("Связь есть" if ... else "Связи нет")
print(f"Порядок курсов по длительности: {...}")
print(f"Порядок курсов по количеству преподавателей: {...}")