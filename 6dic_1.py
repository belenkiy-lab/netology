...
for course, mentors_, duration in zip(courses, mentors, durations ):
	course_dict ={
		'title':course,
		'mentors': mentors_
        'duration': duration
...
courses_max = []
for i in minis:
	courses_min.append(courses_list[i]['title']) # Допишите код, который берёт по id нужный курс из courses_list и получает название курса из ключа "title"
for i in maxes:
	courses_max.append(courses_list[i]['title']) # По аналогии допишите такой же код для курсов максимальной длительности
